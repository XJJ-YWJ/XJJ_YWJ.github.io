...
<meta charset="UTF-8">
		...
		<style type="text/css">
			...
			.content{width: 400px;height: 500px;background-color: #fff;border-radius: 5px;position: relative;left: 450px;top:-140px;}
           .title-content .reg{border-bottom: 2px solid #ea6f5a;}
		...
		<div class="content">
			<h4 class="title">
			    <div class="title-content">
                    <a  class="login"href="login.jsp" style="font-size: 20px;color:#969696 ;letter-spacing: 10px;font-weight: 100；">登录</a>
                    &nbsp;&nbsp;&nbsp;<b style="color:#969696 ;">·</b>&nbsp;&nbsp;&nbsp;
                    <a  class="reg" href="reg.html"style="font-size: 20px;color: #ea6f5a;letter-spacing: 10px;padding-left: 5px;" >注册</a>
                </div>
			</h4>
			<div class="center">
		    	<form action="reg" method="post">
				    ...
				    <input type="password" name="password" placeholder="设置密码" style="border-bottom: hidden;">
				    <input type="text" name="phone"  placeholder="手机号" style="border-radius:  0 0 4px 4px;">
                     <div style="width: 260px;height: 40px;line-height:40px;text-align: center;text-decoration: none;background-color: green;border-radius:20px ;margin-top: 50px;"  >
            	        <input type="submit" value="注册" style="background-color: #3194d0;border-radius:20px ; width: 260px;height: 40px;line-height:40px;text-align: center;text-decoration: none;" />
                    </div>
		    	</form>
		    </div>
		     <!--其他登录方式-->
